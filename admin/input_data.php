...
<head>
  ...
  <title>Tambah Bantuan Sosial</title>
        ...
        <div class="content-wrapper">
          <div class="container-fluid">
            ...
            <div class="row pt-4 justify-content-center">
              <div class="col-md-8">
                <div class="card p-4">
                  <h4 class="text-center">Tambah Bantuan Sosial</h4>
                  <form method="POST" action="loginsert.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="id_jenis_bantuan" required>
                        <?php while ($row = mysqli_fetch_assoc($jenis_result)): ?>
                          <option value="<?= $row['id_jenis_bantuan'] ?>"><?= $row['jenis_bantuan'] ?></option>
                        <?php endwhile; ?>
                      </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="syarat_pendaftaran" required></textarea>
                    </div>

                    <div class="form-group">
                      <label>Mekanisme Pendaftaran</label>
                      <textarea class="form-control" name="mekanisme_pendaftaran" required></textarea>
                    </div>

                    <div class="form-group">
                      <label>Deskripsi Bantuan</label>
                      <textarea class="form-control" name="deskripsi_bantuan" required></textarea>
                    </div>
